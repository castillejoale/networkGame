...
protected boolean formsCluster(Move m, int sidecolor) {
	...
	**/
	protected DList chipConnections(Square s) {
		...
		if (color == -1){ //Not black nor white
	...
	private DListNode leftTopDiagonalConnection(int i, int j, int color, DList list){

		return null;

	}

	private DListNode topVerticalConnection(int i, int j, int color, DList list){

		return null;

	}

	private DListNode rightTopDiagonalConnection(int i, int j, int color, DList list){
	...
	private DListNode rightBottomDiagonalConnection(int i, int j, int color, DList list){

		return null;

	}

	private DListNode bottomVerticalConnection(int i, int j, int color, DList list){

		return null;

	}

	private DListNode leftBottomDiagonalConnection(int i, int j, int color, DList list){
...
**/
  ...
  public static void main (String[] args){
  	...
  	Move m2 = new Move(4,4);
  	Move m3 = new Move(6,4);
  	Move m4 = new Move(4,2);
  	Move m5 = new Move(4,6);
